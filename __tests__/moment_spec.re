      ...
      () => {
        ...
        test("#setDay", () =>
          expect(
            Moment.isSame(
              moment("2018-05-01"),
              moment("2018-05-05") |> Moment.setDay(3) |> Moment.setDay(2),
            ),
          )
          |> toBe(true)
        );
        ...
        test("instantiation", () =>
          expect(Moment.isSame(moment("2017-04-01"), moment("2017-04-01")))
          |> toBe(true)
        );
        ...
        test("#isBefore", () =>
          expect(
            Moment.isBefore(moment("2016-01-01"), moment("2016-01-02")),
          )
          |> toBe(true)
        );
        test("#isSameOrBefore", () =>
        ...
        test("#format", () =>
          expect(moment("2016-01-01") |> Moment.format("YYYY-MM-DD"))
          |> toBe("2016-01-01")
        );
        test(
          /* TODO: test this time-zone independently */
          "#defaultFormat", () =>
          expect(moment("2016-01-01") |> Moment.defaultFormat)
        ...
        test("#second", () =>
          expect(moment("2017-01-02 03:04:05.678") |> Moment.second)
          |> toBe(5)
        );
        test("#minute", () =>
          expect(moment("2017-01-02 03:04:05.678") |> Moment.minute)
          |> toBe(4)
        );
        test("#hour", () =>
          expect(moment("2017-01-02 03:04:05.678") |> Moment.hour)
          |> toBe(3)
        );
        test("#day", () =>
        ...
        test("#month", () =>
          expect(moment("2017-01-02 03:04:05.678") |> Moment.month)
          |> toBe(0)
        );
        test("#year", () =>
          expect(moment("2017-01-02 03:04:05.678") |> Moment.year)
          |> toBe(2017)
        );
        test("#weekday", () =>
    ...
    ExpectJs.(
      () => {
        test("should return correct difference of moments in days", () =>
          expect(diff(moment("2017-01-02"), moment("2017-01-01"), `days))
          |> toBe(1.)
        );
        test("should return correct difference of moments in hours", () =>
          expect(
            diff(
              moment("2017-01-01 02:00:00.000"),
              moment("2017-01-01 00:00:00.000"),
              `hours,
            ),
          )
          |> toBe(2.)
